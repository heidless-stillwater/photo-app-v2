...
class ArtifactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artifact" do
    assert_difference("Artifact.count") do
      post artifacts_url, params: { artifact: { name: @artifact.name, picture: @artifact.picture, user_id: @artifact.user_id } }
    end
  ...
  test "should update artifact" do
    patch artifact_url(@artifact), params: { artifact: { name: @artifact.name, picture: @artifact.picture, user_id: @artifact.user_id } }
